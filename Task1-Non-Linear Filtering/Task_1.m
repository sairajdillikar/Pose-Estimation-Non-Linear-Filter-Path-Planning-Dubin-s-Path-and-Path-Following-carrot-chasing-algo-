...
L=Measurments.l;
h_nl = @(x) [sqrt((L(1,1)-x(1)).^2+(L(1,2)-x(2)).^2);
...
for e = 1:length(t)-1
    z =[Measurments.r(e,1);Measurments.b(e,1);Measurments.r(e,2);Measurments.b(e,2);Measurments.r(e,3);Measurments.b(e,3);Measurments.r(e,4);Measurments.b(e,4);Measurments.r(e,5);Measurments.b(e,5);Measurments.r(e,6);Measurments.b(e,6)];
    ...
    H = H_matrix(xa,Measurments.r(e,:),Measurments.b(e,:),L,0);   
...
hold on
scatter(L(:,1),L(:,2),'r')
legend('Sensor 1','Sensor 2','Sensor 3','Sensor 4','Sensor 5','Sensor 6','Fused','Landmarks')
% 
% plot(t,ChiStat)
% xlabel('Time [s]')
% ylabel('\chi^2')
