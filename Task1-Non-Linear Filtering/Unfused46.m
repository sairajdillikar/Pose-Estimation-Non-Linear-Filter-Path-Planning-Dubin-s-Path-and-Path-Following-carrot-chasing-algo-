...
RFu = diag([SigmaSquare_r2,SigmaSquare_b;]);%,SigmaSquare_r1,SigmaSquare_b,SigmaSquare_r1,SigmaSquare_b,SigmaSquare_r2,SigmaSquare_b,SigmaSquare_r2,SigmaSquare_b,SigmaSquare_r2,SigmaSquare_b;]); 
